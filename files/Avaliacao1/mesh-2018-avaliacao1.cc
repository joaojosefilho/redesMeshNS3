  ...
  for (std::map<FlowId, FlowMonitor::FlowStats>::const_iterator i = stats.begin (); i != stats.end (); ++i)
  {
        ...
        if (i->second.rxBytes > 0){
            ...
            if(m_packetInterval == 0.1){
                ...
                {
                    out.open("avaliacao1/01/taxaEntrega.csv", std::ios::app);
                    out<<(i->second.rxPackets * 100.0)/ (i->second.txPackets)  << ";\n";
                    out.close();
                    
                    out.open("avaliacao1/01/vazao.csv", std::ios::app);
                    out<<i->second.rxBytes * 8.0 / 10.0 / 1024 / 1024  << ";\n";
                    out.close();
                    
                    out.open("avaliacao1/01/atrasoMedio.csv", std::ios::app);
                    out<<(i->second.delaySum.GetSeconds()) / (i->second.rxPackets) << ";\n";
                    out.close();
                    
                    out.open("avaliacao1/01/variacaoAtraso.csv", std::ios::app);
                ...
                if(m_packetSize == 1024)
                {
                    out.open("avaliacao1/001/taxaEntrega.csv", std::ios::app);
                    out<<(i->second.rxPackets * 100.0)/ (i->second.txPackets)  << ";\n";
                    out.close();
                    
                    out.open("avaliacao1/001/vazao.csv", std::ios::app);
                    out<<i->second.rxBytes * 8.0 / 10.0 / 1024 / 1024  << ";\n";
                    out.close();
                    
                    out.open("avaliacao1/001/atrasoMedio.csv", std::ios::app);
                    out<<(i->second.delaySum.GetSeconds()) / (i->second.rxPackets) << ";\n";
                    out.close();
                    
                    out.open("avaliacao1/001/variacaoAtraso.csv", std::ios::app);
                    out<<(i->second.jitterSum.GetSeconds()) / (i->second.rxPackets -1)<< ";\n";
                    out.close();
                ...
                if(m_packetSize == 1024)
                {
                    out.open("avaliacao1/0001/taxaEntrega.csv", std::ios::app);
                    out<<(i->second.rxPackets * 100.0)/ (i->second.txPackets)  << ";\n";
                    out.close();
                    
                    out.open("avaliacao1/0001/vazao.csv", std::ios::app);
                    out<<i->second.rxBytes * 8.0 / 10.0 / 1024 / 1024  << ";\n";
                    out.close();
                    
                    out.open("avaliacao1/0001/atrasoMedio.csv", std::ios::app);
                    out<<(i->second.delaySum.GetSeconds()) / (i->second.rxPackets) << ";\n";
                    out.close();
                    
                    out.open("avaliacao1/0001/variacaoAtraso.csv", std::ios::app);
                    out<<(i->second.jitterSum.GetSeconds()) / (i->second.rxPackets -1)<< ";\n";
                    out.close();
